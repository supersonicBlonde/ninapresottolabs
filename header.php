...
if($user_lang == "fr" || (isset($_GET['lang']) && $_GET['lang'] == 'fr')) {
  header("Location: https://ninapresotto.com/fr/home-fr");
  die();
}
...
<html lang="en">
  <head>
    ...
    <link rel="alternate" href="https://ninapresotto.com/fr/home-fr" hreflang="fr" />
  ...
  <body>
    <header class="header">
      <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand no-deco" href="/"><span><strong>Nina Presotto</strong></span><span style="display:block">Senior Wordpress Developer</span></a>
        ...
        <a class="no-deco flagnav m-2"  href="/fr/home-fr">
          <img src="dist/img/fr-flag.png" alt="French" width="18" height="12">
        </a>

        <div class="navbar-toggler second-button" role="button" data-toggle="collapse" aria-expanded="false">
          <div class="animated-icon2"><span></span><span></span><span></span></div>
        </div>
        <div class="nav-slider">
          <ul class="nav navbar-nav ml-auto mr-3">
           <!--  <li class="nav-item">
              <a class="nav-link no-deco nav-services" href="#services-section">Services</a>
            </li> -->
            <li class="nav-item">
              <a class="nav-link no-deco <?php if($current == 'work'){ echo 'active';} ?>" href="work" >Recent work</a>
            </li>
            <li class="nav-item">
              <a class="nav-link no-deco <?php if($current == 'about'){ echo 'active';} ?>" href="about">About</a>
            </li>
            <li class="nav-item">
              <a class="nav-link no-deco <?php if($current == 'contact'){ echo 'active';} ?>" href="contact">Say hello</a>
            </li>
            <li class="nav-item">
              <a class="no-deco flag"  href="https://ninapresotto.com?lang=fr">
                <img src="dist/img/fr-flag.png" alt="French" width="18" height="12">
              </a>
            </li>
          </ul>
